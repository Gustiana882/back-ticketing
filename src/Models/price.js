...
class Prices {
	...
	getIdMaskapai(id_Maskapai) {
		return new Promise((resolve, reject) => {
			this.table
				.findAll({ where: { id_Maskapai: id_Maskapai } })
				.then((res) => {
					resolve(res);
				})
				.catch((err) => {
	...
	getClass(class_type) {
		return new Promise((resolve, reject) => {
			this.table
				.findAll({ where: { class_type: class_type } })
				.then((res) => {
					resolve(res);
				})
				.catch((err) => {
	...
	addPrice(data) {
		return new Promise((resolve, reject) => {
			const { id_Maskapai, dewasa, anak, class_type } = data;
			this.table
				.create({ id_Maskapai, dewasa, anak, class_type })
				.then((res) => {
					console.log(data);
	...
	updatePrice(data) {
		return new Promise((resolve, reject) => {
			const { id_Maskapai, id, dewasa, anak, class_type } = data;
			this.table
				.update(
